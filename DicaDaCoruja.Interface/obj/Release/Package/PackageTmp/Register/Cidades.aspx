<%@ Page Title="" Language="C#" MasterPageFile="~/Register/Register.Master" AutoEventWireup="true" CodeBehind="Cidades.aspx.cs" Inherits="DicaDaCoruja.Interface.Register.Cidades" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Centro" runat="server">
    <div class="BordaAzulEsc Alt420" style="width: 100%;">
        <div class="Margin1 TxtCenter DivGridView" >
            <asp:GridView ID="GridCidades" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="100%" >
        ...
        <div class="Margin1" style="border: 1px solid black; min-height: 120px;">
            <asp:TextBox ID="TextCidade" Text="" runat="server" placeholder="Nome da cidade" CssClass="Margin1" Style="width: 250px;" />
            <asp:TextBox ID="TextEstado" Text="" runat="server" placeholder="Estado (SP)" CssClass="Margin1" Style="width: 150px;" />
        </div>
